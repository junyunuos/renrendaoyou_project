...
- (void)drawRect:(CGRect)rect
{
    ...
    [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
       ...
       // NSLog(@"%@",self.selectedSegmentLayer.frame);
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, 50.0, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, 50.0, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
